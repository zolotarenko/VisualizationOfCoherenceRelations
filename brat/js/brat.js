...
// Dynamic extraction of the entered text to parse

function getDocText() {
  var searchText = document.getElementById("searchText").value;
  var searchBtn = document.getElementById('searchBtn').addEventListener('click', getDocData(searchText));
  document.getElementById("demo").innerHTML = searchText;
  return searchText;

}

function getDocData(text){
    var xhr = new XMLHttpRequest();
    var url = "http://localhost:5500/parse?viz=true&input=" + text;
...
head.ready(function() {
    ...
    $.extend({}, getDocData(docText)), webFontURLs);
